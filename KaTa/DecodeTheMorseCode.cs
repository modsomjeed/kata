...
namespace CodeWars.KaTa
{
    public static class MorseCodeDecoder
    {
        ...
        {
            var morseCodeWords = morseCode.Trim().Split("   ");
            var decodedWords = new List<string>();

            foreach (var morseCodeWord in morseCodeWords)
            {
                var morseCodeLetters = morseCodeWord.Split(" ");
                var decodedWord = string.Empty;

                foreach (var morseCodeLetter in morseCodeLetters)
                {
                    decodedWord += MorseCode.Get(morseCodeLetter);
                }
